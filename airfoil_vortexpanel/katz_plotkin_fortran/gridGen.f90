...
OPEN(8,FILE='AFOIL3.DAT',STATUS='NEW')
...
COM1=((R1**AK)/(R2**(AK-1)))/((COS((AK-1)*TH2))**2+(SIN((AK-1)*TH2))**2)
X=COM1*(COS(AK*TH1)*COS((AK-1)*TH2)+SIN(AK*TH1)*SIN((AK-1)*TH2))+TL
Y=COM1*(SIN(AK*TH1)*COS((AK-1)*TH2)-COS(AK*TH1)*SIN((AK-1)*TH2))
WRITE(8,*) X,' ,',Y
!THIS PART COMPUTES THE TRANSFORMED PRESSURE
!DISTRIBUTION
