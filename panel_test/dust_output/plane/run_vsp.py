...
if __name__=='__main__':
    ...
    geo_files, geo_names, mesh_stats = vspDegen2DustBasic('plane_DegenGeom.csv', 'Model/', -0.75, show=False, dup_chck='Full', scale=1/3.28)
    ...
    conv_options['comp_axes'] = [[0,0,1], [0,0,1], [0,0,0]]
    conv_options['comp_frames'] = ['local', 'local', 'local']
